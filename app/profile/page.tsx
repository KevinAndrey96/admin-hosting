  ...
  return (
    <AdminLayout>
      <div className="container-fluid" style={{ background: 'var(--c-bkg-body)', minHeight: '100%', padding: '24px' }}>
        <div className="card bdrs-3" style={{ boxShadow: 'var(--shadow-card)', border: '1px solid var(--c-border)' }}>
          <div className="card-header bgc-white bdT-0 bdrs-3" style={{ padding: '20px 24px', borderBottom: '1px solid var(--c-border)' }}>
          ...
          <div className="card-body p-24">
            <div className="row gap-20">
              <div className="col-md-6">
                <div className="bd p-20 bdrs-3" style={{ minHeight: 200, backgroundColor: 'var(--c-bkg-hover)', borderColor: 'var(--c-border)' }}>
              ...
              {profileLoading ? (
                ...
                <div className="d-f fxd-c gap-3">
                  <div>
                    ...
                    <p className="m-0 fw-500 c-grey-800">{profile.fullName}</p>
                  </div>
                  <div>
                    <label className="form-label fsz-sm c-grey-600">Correo electrónico</label>
                    <p className="m-0 fw-500 c-grey-800">{profile.email}</p>
                  </div>
                  <div>
                    <label className="form-label fsz-sm c-grey-600">Teléfono</label>
                    <p className="m-0 fw-500 c-grey-800">{profile.phone || '—'}</p>
                  </div>
                  <div>
              ...
              <form onSubmit={handleChangePassword}>
                <div className="mb-3">
                  <label htmlFor="current-password" className="form-label c-grey-700">
                    Contraseña actual
                  </label>
                  <input
                    type="password"
                ...
                <div className="mb-3">
                  <label htmlFor="new-password" className="form-label c-grey-700">
                    Nueva contraseña
                  </label>
                  <input
                    type="password"
                ...
                <div className="mb-3">
                  <label htmlFor="confirm-password" className="form-label c-grey-700">
